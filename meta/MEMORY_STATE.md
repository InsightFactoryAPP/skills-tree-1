...
| Key | Value |
|---|---|
| Main HEAD at task baseline | `7cc77dfa71ea3c0a0aeb0d8668b5eb583e4c94ea` |
...
| Current audit-derived slice | Adapter model-target ontology boundary — merged |
| Active branch | `main` |
